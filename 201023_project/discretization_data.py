...
Input_data = pd.read_csv('F:/data/ADD/201023_data/anomaly_data.csv')

temp_table = table_from_frame(Input_data, 'Label')
...
temp_df.to_csv("F:/data/ADD/201023_data/disc_anomaly_data.csv", index=False)