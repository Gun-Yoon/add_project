...
Input_data = pd.read_csv('F:/data/KDD99/NSL-KDD/train_test/Train_data.csv')

temp_table = table_from_frame(Input_data, 'actual')
...
temp_df.to_csv("F:/data/KDD99/NSL-KDD/train_test/disc_Train_data.csv", index=False)